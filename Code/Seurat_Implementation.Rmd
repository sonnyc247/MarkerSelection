...
Seu_AIBS_markers_stringent <- FindAllMarkers(object = Seu_AIBS_obj_it2, slot = "data", logfc.threshold = 1, test.use = "MAST", min.pct = .7, min.diff.pct = .8, only.pos = TRUE, return.thresh = .05) 

# trying a different test for comparing gene expression between different groups, also usable in Seurat

Seu_AIBS_markers_roc <- FindAllMarkers(Seu_AIBS_obj_it2, logfc.threshold = 2.5, min.pct = .35, only.pos = TRUE, return.thresh = .05, test.use = "roc")

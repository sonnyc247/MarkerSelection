...
tome_sample_meta_filtered <- tome_sample_meta_filtered[!(tome_sample_meta_filtered$class_label!="Non-neuronal" & tome_sample_meta_filtered$region_label!="MTG"),] # for our purposes/demonstration, we remove all neurons not from the ACC
...
# Into Seurat
Seu_AIBS_obj_ACC <- Seu_AIBS_obj #save a copy of previous Seurat object 
Seu_AIBS_obj_ACC_it2 <- Seu_AIBS_obj_it2 #save a copy of previous Seurat object
...
Seu_AIBS_obj <- Seu_AIBS_obj_it2
remove(Seu_AIBS_obj_it2)

Seu_AIBS_markers_MTG <- FindAllMarkers(Seu_AIBS_obj, logfc.threshold = 2.5, min.pct = .35, only.pos = TRUE, return.thresh = .05, test.use = "MAST")
Seu_AIBS_markers_MTGroc <- FindAllMarkers(Seu_AIBS_obj, logfc.threshold = 2.5, min.pct = .35, only.pos = TRUE, return.thresh = .05, test.use = "roc")
